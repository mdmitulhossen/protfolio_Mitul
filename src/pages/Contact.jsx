            ...
            <div>
                ...
                <form className="py-4 px-7">
                    <div className="grid grid-cols-2 gap-2">
                        <div>
                            <input className="w-full  px-5 py-2 rounded-md border-[#949B9B]/50 focus:outline-0" type="text" placeholder="Your Name" />
                        </div>
                        <div>
                            <input className="w-full  px-5  py-2 rounded-md border-[#949B9B]/50 focus:outline-0" type="text" placeholder="Your Email" />
                        </div>
                    </div>
                
                    <div className="pt-5">
                        <textarea className="w-full h-[80px] px-5 py-2 rounded-md border-[#949B9B]/50 focus:outline-0" type="text" placeholder="Message"></textarea>
                    </div>
                    <div className="pt-5">
                        <button className="w-full py-[2px] h-[30px] rounded-md border-[#949B9B]/50 bg-[#F6B846] text-[#222222] font-bold flex justify-center items-center gap-3">Send Message <FaTelegramPlane color="#fff"/></button>
                    </div>
                </form>
            </div>
        </div>
